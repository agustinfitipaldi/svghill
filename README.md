...
# What the Data Shows
Clips 1 through 6 represent six consecutive laps through Turn 3. They cluster tightly in both speed and RPM.

Clip 7 is the collision lap, it diverges from the cluster roughly half a second before contact. The RPM trace, which on every other lap settles around 7000-7500 at the apex, drops to 5142 at the moment of impact.

The MPH plot reveals something subtler but equally important. Hill's speed at the moment of contact isn't dramatically different from some other laps, but the shape of the deceleration is fundamentally different. On clips 1–6, the speed curve is flattening out by this point in the corner, the car has finished decelerating and is carrying its normal apex speed. On clip 7, the curve is still falling and accelerating downward at the moment of contact, indicating additional braking or throttle lift beyond what the corner demanded. In other words, clips 1-6 show a concave up velocity curve while clip 7 shows a concave down velocity curve.
# Radio Context
